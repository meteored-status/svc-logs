 ...
 * Hash: dab0e632dbb9f32f6f0d01a5ff366fb9
...
export const emitirValor = (value: JSONValue, item: JSONItem, module: ModuloJSON, definition: Definition, langKey: string, sufijo: string): IValorEmitido => {
    ...
    if (value.type == "singular") {
        imports.push(`import {SingularValue} from "services-comun/modules/traduccion/v2/value/singular-value";`);
    ...
    imports.push(`import pluralBuilder from "services-comun/modules/traduccion/v2/util/plural-function-builder";`);
    imports.push(`import {PluralValue} from "services-comun/modules/traduccion/v2/value/plural-value";`);
    imports.push(`import {TPluralKey} from "services-comun/modules/traduccion/v2/value";`);
