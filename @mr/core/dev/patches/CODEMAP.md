...
getRulesSince(lastPatch)                     // → Rule[] — reglas pendientes desde cursor
...
### Orden de evaluación de `RULES` (importante: subpaths antes que paths padre)
```
R003 → R002 → R006 → R007 → R004 → R005 → R001 → R008 → R009 → R010
→ R011 → R012 → R013 → R014 → R015 → R016 → R017 → R019 → R020 → R018
→ R011 → R012 → R013 → R014 → R015 → R016 → R017 → R019 → R020 → R018
```
