 ...
 * Hash: 70a0ed060511c1a1982ae1cd5b6f6ac9
 * Versión: 2026.6.17+1-josantoniojimnez
 */

import {type INet, Net} from "@mr/core-network/server/http/config/net";
import type {Service} from "@mr/core-network/server/http/service";

import {Configuracion, type IConfiguracion} from ".";
